...
class ModelRouter:
    ...
    def classify_task(self, message: str, context_tokens: int = 0) -> TaskComplexity:
        ...
        complex_keywords = [
            "refactor", "architect", "multi-file", "debug sâu",
            "tái cấu trúc", "kiến trúc", "nhiều file", "gỡ lỗi sâu",
            "redesign", "restructure", "overhaul", "migrate",
            "tối ưu hóa toàn bộ", "viết lại", "rewrite"
        ]
        ...
        simple_keywords = [
            "comment", "format", "add docstring", "add type hint",
            "thêm comment", "định dạng", "thêm docstring", "thêm type hint",
            "rename variable", "đổi tên biến", "sửa lỗi chính tả", "fix typo",
            "thêm dòng trống", "sắp xếp import", "sort imports"
        ]
